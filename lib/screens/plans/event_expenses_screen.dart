...
const _eventExpenseCategories = [
  'Catering', 'Venue', 'Decoration', 'Photography', 'Music',
  'Transport', 'Stationery', 'Gifts', 'Other'
];

class EventExpensesScreen extends StatelessWidget {
  final EventPlan event;
  const EventExpensesScreen({super.key, required this.event});

  @override
  Widget build(BuildContext context) {
    final budgetId = event.budgetId;
    if (budgetId == null) {
      return Scaffold(
        ...
        body: const EmptyPlanState(
          ...
          subtitle: 'Create an event with a budget to track expenses.',
        ),
      );
    }
                ...
                children: [
                  ...
                  if (expenses.isEmpty &&
                    ...
                    const EmptyPlanState(
                      ...
                      subtitle:
                          'Track your event spending by adding expenses.',
                    )
                  else ...[
                    Text('Expenses',
                        style: GoogleFonts.montserrat(
  ...
  void _showAddExpenseSheet(BuildContext context, String budgetId) {
    showModalBottomSheet(
      ...
      builder: (_) => AddExpenseSheet(
        budgetId: budgetId,
        categories: _eventExpenseCategories,
      ),
    );
  }
}
...
class _ExpenseRow extends StatelessWidget {
  ...
  const _ExpenseRow({required this.expense, required this.budgetId});
